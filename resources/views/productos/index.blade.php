                        ...
                        <div class="container-articles" id="contenedor-articulos">
                            ...
                            <div class="row col-md-12" id="articulos-img">
                                ...
                                <form class="formulario-eliminar" action="{{ route('eliminarProducto', $producto->idProducto)}}" method="POST" >
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-danger" id="button-shop" type="submit"   style="padding-right:3.6rem!important;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16" style="margin-left:40px!important;">
