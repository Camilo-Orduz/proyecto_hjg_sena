...
<div class="container-fluid" >
    <div class="row flex-nowrap">
        ...
        <h3 id="title">Entrada</h3> 
                ...
                <input name="identificacionEmpleado" class="form-control" type="text" placeholder="Tipo de prenda" aria-label="default input example" required><br>
                <label for="exampleDataList" class="form-label">Cantidad</label> 
                <input class="form-control" type="number" placeholder="Cantidad" aria-label="default input example" name="" required><br>
                <label for="exampleDataList" class="form-label">Detalles entrada</label> 
                <input class="form-control" type="text" placeholder="Detalle de la prenda" aria-label="default input example" name="" required><br>
